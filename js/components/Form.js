export const Form = () => {
  return `
    <form class="d-flex flex-column gap-3 form" id="taskForm">
    ...
    <div class="group d-flex flex-column">
      ...
      <small class="form-text">
        Ten en cuenta que, por defecto la tarea queda en "No Empezado". Si no cambias el estado, se guardará así.
      </small>
    </div>
    ...
    <button type="submit" class="btn btnAdd" id="btnAddTask">
